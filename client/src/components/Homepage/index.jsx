...
const Homepage = () => {
  ...
  return (
    <div className="mt-10 mb-10">
      {Auth.loggedIn() ? (
        <>
          <h1 className="text-5xl font-semibold my-8 sm:text-7xl hover:cursor-default">
            Hello {user.username}!
          </h1>
        </>
      ) : (
        <h1 className="text-xl font-semibold my-8 hover:cursor-default">
          Please sign in or register!
        </h1>
      )}
      <h1 className="text-3xl font-semibold sm:text-5xl hover:cursor-default">
        ...
        <div className="flex-col">
          ...
          >
            <img
              src={recipeIcon}
              className={`w-40 h-40 ${
                recipeHovered ? "filter brightness-200" : ""
              }`}
              alt="Recipe Icon"
            />
          </Link>
          <h2 className="text-xl font-semibold text-center hover:cursor-default">
            Recipes
          </h2>
        </div>
        <div className="flex-col">
          ...
          >
            <img
              src={groceryIcon}
              className={`w-40 h-40 ${
                groceryHovered ? "filter brightness-200" : ""
              }`}
              alt="Grocery Icon"
            />
          </Link>
      ...
      <h1 className="text-3xl font-semibold my-8 sm:text-5xl hover:cursor-default">
        Coupons & Deals
      </h1>
      <CouponSlider />
    </div>
