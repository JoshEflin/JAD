const groceryData = [
  ...
  },
  {
    name: "Pepper",
    description:
      " Pepper refers to the dried fruits of the Piper nigrum plant and is used as a spice to add heat and flavor to dishes. It comes in various forms, such as black pepper, white pepper, and red pepper.",
    photo:
  ...
  },
  {
    name: "Olive oil",
    description:
      "Olive oil is a liquid fat extracted from olives and is widely used in cooking and dressing. It is known for its health benefits and is often used as a healthier alternative to other cooking oils",
    photo:
  ...
  },
  {
    name: "Butter",
    description:
      " Butter is a dairy product made from the fat and protein components of milk or cream. It is commonly used in baking, cooking, and as a spread on bread. ",
    photo:
  ...
  },
  {
    name: "Garlic",
    description:
      "Garlic is a plant in the Allium family and is used as a flavoring ingredient in various cuisines. It has a strong, pungent taste and aroma and is known for its potential health benefits",
    photo:
  ...
  },
  {
    name: "Onion",
    description:
      "Onion is a bulb vegetable commonly used in cooking as a flavoring ingredient. It comes in different varieties and adds a distinct taste and aroma to dishes",
    photo:
  ...
  },
  {
    name: "Flour",
    description:
      "Flour is a finely ground powder made from cereal grains, legumes, or roots. It is a fundamental ingredient in baking and cooking, used to make bread, cakes, pastries, and more.",
    photo:
  ...
  },
  {
    name: "Sugar",
    description:
      "Sugar is a sweet, crystalline substance extracted from various sources like sugarcane and sugar beets. It is widely used as a sweetener in cooking, baking, and beverages.",
    photo:
  ...
  },
  {
    name: "Egg",
    description:
      "Eggs are laid by various animals, most commonly hens, and are widely used in cooking and baking. They are a versatile ingredient and can be prepared in numerous ways.",
    photo:
  ...
  },
  {
    name: "Milk",
    description:
      "Milk is a nutrient-rich liquid produced by mammals, primarily cows. It is consumed as a beverage and used as an ingredient in various recipes, including dairy products and baked goods.",
    photo:
  ...
  },
  {
    name: "Tomatoes",
    description:
      "A Red fredgetable (fruit and vegetable hybrid) gifted by God to confuse the Plebs",
    photo:
  ...
  },
  {
    name: "Beef",
    description:
      "Ever thought about how you could eat a cow more effectively? Try BEEF!",
    photo:
  ...
  },
  {
    name: "Pasta",
    description:
      "Pasta is an italian invention that can only be properly cooked by an individual of italian heritage",
    photo:
  ...
  },
  {
    name: "Potato",
    description:
      "A heavy, hard, white globular plant root that is some how edible",
    photo:
  ...
  },
  {
    name: "Green beans",
    description:
      " For an accurate description of green beans, please consult the Bean book that Dan Gross always has on hand",
    photo:
  ...
  },
  {
    name: "Cucumber",
    description:
      " Often referred to as cukes, these long cylindrical objects make for great dill pickles",
    photo:
  ...
  },
  {
    name: "Lemon",
    description:
      "Do you hate your mouth! Try a lemon, its citric sour flavor will surely make you wish you never ate one",
    photo:
  ...
  },
  {
    ...
    description:
      "Oranges are citrus fruits known for their refreshing taste and high vitamin C content. They are typically round in shape with a bright orange color and a juicy flesh. Oranges are popular for their tangy flavor and are commonly consumed as a snack or used in various culinary applications.",
  },
  {
    name: "Apple",
    photo:
    ...
    description:
      "Apples are crisp and sweet fruits that come in various colors, including red, green, and yellow. They have a round shape and are known for their crunchy texture. Apples are a popular fruit worldwide and are enjoyed both raw and cooked. They are rich in fiber, antioxidants, and vitamin C.",
  },
  {
    name: "Banana",
    photo:
...

  {
    ...
    description:
      "Raspberries are small, delicate berries with a sweet and slightly tart flavor. They are known for their vibrant red color and tiny seeds that give them a textured appearance. Raspberries are rich in antioxidants, vitamins, and fiber. They are commonly enjoyed fresh, added to desserts, used in jams and jellies, or incorporated into baked goods.",
  },
  {
    name: "Blackberry",
    photo:
    ...
    description:
      "Blackberries are dark-colored berries with a sweet and tangy taste. They have a distinctive juicy texture and are known for their high nutritional value. Blackberries are packed with antioxidants, vitamins, and fiber. They can be eaten fresh, added to fruit salads, used in pies and pastries, or blended into smoothies.",
  },
  {
    name: "Avocado",
    photo: "https://thumbs.dreamstime.com/z/avocado-18188183.jpg",
    description:
      "Avocado is a versatile fruit with a creamy texture and a mild, nutty flavor. It has a dark green outer skin and a soft, buttery flesh inside. Avocados are rich in healthy fats, fiber, and various vitamins and minerals. They are commonly used in guacamole, salads, sandwiches, and as a topping for toast.",
  },
  {
    name: "Corn",
    photo:
    ...
    description:
      "Corn, also known as maize, is a cereal grain that comes in various colors, including yellow, white, and bi-colored varieties. It has a sweet and slightly starchy taste. Corn is a staple food in many cuisines and is used in numerous dishes, including soups, salads, stir-fries, and as a side dish. It is a good source of dietary fiber and essential nutrients.",
  },
  {
    name: "Peas",
    photo:
  ...
  },
  {
    ...
    description:
      "Basil is a fragrant herb with vibrant green leaves and a sweet, peppery flavor. It is widely used in Mediterranean, Italian, and Thai cuisines. Basil leaves are popularly used in pesto sauce, salads, pasta dishes, and as a garnish. It adds a delightful aroma and a touch of freshness to a variety of recipes.",
  },
  {
    name: "Oregano",
    photo:
    ...
    description:
      "Oregano is a culinary herb with small, pungent leaves and a robust, earthy flavor. It is commonly used in Mediterranean and Italian cuisines, particularly in tomato-based dishes, pizzas, pasta sauces, and grilled meats. Oregano adds a savory and aromatic quality to recipes and is often used dried or fresh.",
  },
  {
    name: "Thyme",
    photo:
    ...
    description:
      "Thyme is a fragrant herb with tiny leaves and a warm, earthy flavor. It is widely used in Mediterranean, French, and Middle Eastern cuisines. Thyme leaves are used in soups, stews, roasted meats, marinades, and various vegetable dishes. It adds a distinctive aroma and a hint of sweetness to savory recipes.",
  },
  {
    name: "Rosemary",
    photo:
    ...
    description:
      "Rosemary is an aromatic herb with needle-like leaves and a piney, woody flavor. It is commonly used in Mediterranean and Italian cuisines, particularly in roasted meats, potatoes, bread, and marinades. Rosemary adds a fragrant and robust taste to dishes and is often used dried or fresh.",
  },
  {
    name: "Sage",
    photo:
    ...
    description:
      "Sage is an aromatic herb with gray-green leaves and a savory, slightly peppery flavor. It is commonly used in Mediterranean and European cuisines, particularly in roasted meats, sausages, stuffings, and savory baked goods. Sage adds a distinctive and earthy taste to dishes and is often used dried or fresh.",
  },
  {
    name: "Bay leaf",
    photo:
    ...
    description:
      "Bay leaf is an aromatic leaf commonly used as a seasoning in various cuisines, including Mediterranean, Indian, and Caribbean. It has a subtle, herbal flavor with a hint of floral and balsamic notes. Bay leaves are typically used in soups, stews, sauces, and braised dishes to add depth and complexity to the flavors.",
  },
  {
    name: "Cumin",
    photo:
  ...
  },
  {
    ...
    description:
      "Curry powder is a spice blend that varies in flavor and heat level depending on the region and recipe. It typically includes a combination of ground spices such as turmeric, coriander, cumin, fenugreek, and chili powder",
  },
  {
    name: "Ginger",
    photo:
    ...
    description:
      "Ginger is a pungent and aromatic root commonly used in Asian and Indian cuisines. It has a spicy, warm, and slightly sweet flavor. Ginger can be used fresh, dried, or ground, and it adds a zesty kick to dishes. It is often used in stir-fries, curries, marinades, teas, and baked goods.",
  },
  {
    name: "Soy sauce",
    photo:
  ...
  },
  {
    ...
    description:
      "Vinegar is a sour liquid made through the fermentation of various sources, such as grapes, apples, or rice. It is used in cooking, baking, and dressing. Vinegar adds acidity and tanginess to dishes and can enhance flavors. It is commonly used in salad dressings, marinades, pickling, and sauces.",
  },
  {
    ...
    description:
      "Worcestershire sauce is a tangy and savory condiment with a complex flavor profile. It is made from fermented anchovies, vinegar, molasses, tamarind, and various spices. Worcestershire sauce adds depth, umami, and a hint of sweetness to dishes. It is commonly used in marinades, sauces, gravies, and Bloody Mary cocktails.",
  },
  {
    name: "Mustard",
    photo:
    ...
    description:
      "Mustard is a condiment made from ground mustard seeds, water, vinegar, and other optional ingredients. It has a pungent, tangy, and slightly spicy flavor. Mustard comes in various forms, including yellow, Dijon, and whole grain, each with its own distinct taste and texture. It is used in dressings, marinades, sandwiches, and as a flavoring in cooking.",
  },
  {
    name: "Ketchup",
    photo:
    ...
    description:
      "Ketchup is a popular condiment made from tomatoes, vinegar, sugar, and various seasonings. It has a sweet and tangy flavor and is commonly used as a topping or dipping sauce. Ketchup pairs well with burgers, fries, hot dogs, and other savory dishes.",
  },
  {
    name: "Mayonnaise",
    photo:
    ...
    description:
      "Mayonnaise is a creamy condiment made from egg yolks, oil, vinegar or lemon juice, and seasonings. It has a rich and smooth texture and a tangy flavor. Mayonnaise is used as a spread for sandwiches, a base for salad dressings, and an ingredient in various sauces and dips.",
  },
  {
    name: "Hot sauce",
    photo:
    ...
    description:
      "Hot sauce is a spicy condiment made from chili peppers, vinegar, and other ingredients. It adds heat, flavor, and a kick to dishes. Hot sauce comes in various levels of spiciness and flavor profiles, ranging from mild to extremely hot. It is used to enhance the taste of foods like tacos, wings, and soups.",
  },
  {
    name: "Salsa",
    photo:
    ...
    description:
      "Salsa is a flavorful sauce made from tomatoes, onions, peppers, herbs, and spices. It has a fresh and tangy taste with varying degrees of spiciness. Salsa is commonly used as a dip for tortilla chips, a topping for tacos and burritos, or as a condiment to add flavor to various dishes.",
  },
  {
    name: "Pesto",
    photo:
    ...
    description:
      "Pesto is a vibrant green sauce made from basil, garlic, pine nuts, olive oil, Parmesan cheese, and sometimes other ingredients like spinach or parsley. It has a fresh and herbaceous flavor. Pesto is commonly used as a pasta sauce, a spread for sandwiches, or a topping for grilled meats and vegetables.",
  },
  {
    name: "Honey",
    photo:
    ...
    description:
      "Honey: The Sweet Nectar of the Beehive, crafted by nature's little helpers. With its golden hue and delightful sweetness, Honey adds a touch of magic to your favorite treats. Whether drizzled over pancakes, stirred into tea, or used as a natural sweetener, Honey brings a taste that's simply bee-licious!",
  },
  {
    name: "Maple syrup",
    photo:
    ...
    description:
      "Maple syrup: The Liquid Gold harvested from enchanted forests. With its rich amber color and distinct flavor, Maple syrup conjures visions of crisp autumn mornings and cozy log cabins. Let this sweet elixir cascade over your pancakes, waffles, or French toast, and embark on a deliciously whimsical journey!",
  },
  {
    name: "Molasses",
    photo:
  ...
  },
  {
    ...
    description:
      "Red wine vinegar: The Essence of Fermented Grapes, aged to unlock its vibrant flavors. With its robust acidity and deep red color, Red wine vinegar adds a zesty and tangy twist to your dressings, sauces, and pickled delights. Let its spirited character and wine-infused charm elevate your culinary adventures!",
  },
  {
    name: "White wine vinegar",
    photo:
      "https://www.edamam.com/food-img/0d2/0d278348c2429aab1b76043eaf0ef6f5.png",
    description:
      "White wine vinegar: A Taste of Withered Dreams, distilled from the forgotten hopes of grapes. With its pale, lifeless hue and sharp tang, White wine vinegar exudes a sense of melancholy. Its sour notes and lost potential make it a poignant companion for dressings, marinades, and culinary fare that yearn for a touch of sorrow.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Lime juice: The Bitter Elation of Lost Limes, squeezed from faded memories. With its greenish tinge of melancholy and its puckering sourness, Lime juice carries a burden of sadness. Its zesty allure and astringent flavor bring a hint of sorrow to beverages, marinades, and culinary creations, a reminder of life's tangy disappointments.",
  },
  {
    name: "Fish sauce",
    photo:
  ...
  },
  {
    ...
    description:
      "Sesame seeds: These tiny seeds pack a flavorful punch and add a delightful crunch to your dishes. With their delicate nutty taste and slightly toasted aroma, sesame seeds are a versatile ingredient that can elevate both sweet and savory recipes. Sprinkle them over salads, stir-fries, or use them as a crust for baked goods to enjoy their unique texture and rich taste.",
  },
  {
    name: "Flax seeds",
    photo:
    ...
    description:
      "Flax seeds: These small but mighty seeds are packed with nutritional benefits. Known for their high content of omega-3 fatty acids and fiber, flax seeds are a great addition to your diet. Incorporate them into your smoothies, sprinkle them over yogurt or oatmeal, or use them as an egg substitute in baking. Discover the nutty flavor and healthful properties of flax seeds in your favorite recipes.",
  },
  {
    name: "Chia seeds",
    photo:
  ...
  },
  {
    ...
    description:
      "Quinoa: This ancient grain is renowned for its nutritional value and versatility in the kitchen. With its light and fluffy texture and nutty flavor, quinoa is a perfect accompaniment to your main dishes. Use quinoa as a base for salads, as a side dish, or even as the star ingredient in creative main courses. Explore new recipes and discover the versatility of quinoa in your cooking.",
  },
  {
    name: "Couscous",
    photo:
    ...
    description:
      "Couscous: This fine semolina grain is a staple in North African cuisine. With its light and fluffy texture, couscous lends itself to a wide variety of preparations. Whether used as a base for main dishes or as part of salads and side dishes, couscous adds a pleasant texture and pairs well with different flavors. Try new recipes and explore the versatility of couscous in your culinary adventures.",
  },
  {
    name: "Bulgur",
    photo:
  ...
  },
  {
    ...
    description:
      "Chicken broth is a flavorful liquid made by simmering chicken bones, vegetables, herbs, and spices. It is commonly used as a base for soups, stews, sauces, and risottos. Chicken broth adds depth and richness to dishes, enhancing their flavors. It can be made from scratch using homemade chicken stock or purchased as a ready-to-use product. Whether you're looking to create a comforting bowl of chicken noodle soup or adding a savory touch to your favorite recipes, chicken broth brings a delicious and aromatic element to your culinary creations.",
  },
  {
    name: "Beef broth",
    photo:
    ...
    description:
      "Beef broth is a savory liquid made by simmering beef bones, vegetables, herbs, and spices. It is commonly used as a base for soups, stews, sauces, and gravies. Beef broth imparts a rich and hearty flavor to dishes, adding depth and complexity. It can be made from scratch using homemade beef stock or purchased as a pre-made product. Whether you're creating a comforting bowl of beef stew or enhancing the flavors of your favorite recipes, beef broth brings a robust and savory element to your culinary creations.",
  },
  {
    ...
    description:
      "Vegetable broth is a flavorful liquid made by simmering a variety of vegetables, herbs, and spices. It is commonly used as a base for vegetarian and vegan soups, stews, sauces, and risottos. Vegetable broth adds a delicate and savory taste to dishes, enhancing their flavors. It can be made from scratch using a combination of vegetables or purchased as a convenient ready-to-use product. Whether you're looking to create a comforting vegetable soup or adding a flavorful touch to your favorite recipes, vegetable broth brings a nourishing and aromatic element to your culinary creations.",
  },
  {
    name: "Coconut oil",
    photo:
    ...
    description:
      "Coconut oil is a versatile and popular cooking oil derived from the meat of mature coconuts. It has a mild and pleasant",
  },
  {
    name: "Canola oil",
    photo:
